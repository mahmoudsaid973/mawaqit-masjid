// #739 Wave 13 — generated typed module boundary for src/components/ui/button.tsx.
...
export const Button: MissingModuleShape = __moduleSurface;
export type Button = MissingModuleShape;
