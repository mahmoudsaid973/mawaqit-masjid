// #739 Wave 13 — generated typed module boundary for src/components/ui/separator.tsx.
...
export const Separator: MissingModuleShape = __moduleSurface;
export type Separator = MissingModuleShape;
