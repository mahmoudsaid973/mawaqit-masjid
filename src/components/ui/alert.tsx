// #739 Wave 13 — generated typed module boundary for src/components/ui/alert.tsx.
...
export const Alert: MissingModuleShape = __moduleSurface;
export type Alert = MissingModuleShape;
export const AlertDescription: MissingModuleShape = __moduleSurface;
export type AlertDescription = MissingModuleShape;
