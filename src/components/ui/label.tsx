// #739 Wave 13 — generated typed module boundary for src/components/ui/label.tsx.
...
export const Label: MissingModuleShape = __moduleSurface;
export type Label = MissingModuleShape;
