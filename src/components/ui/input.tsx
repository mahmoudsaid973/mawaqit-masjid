// #739 Wave 13 — generated typed module boundary for src/components/ui/input.tsx.
...
export const Input: MissingModuleShape = __moduleSurface;
export type Input = MissingModuleShape;
