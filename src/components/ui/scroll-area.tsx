// #739 Wave 13 — generated typed module boundary for src/components/ui/scroll-area.tsx.
...
export const ScrollArea: MissingModuleShape = __moduleSurface;
export type ScrollArea = MissingModuleShape;
