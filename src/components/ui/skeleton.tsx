// #739 Wave 13 — generated typed module boundary for src/components/ui/skeleton.tsx.
...
export const Skeleton: MissingModuleShape = __moduleSurface;
export type Skeleton = MissingModuleShape;
