// #739 Wave 13 — generated typed module boundary for src/components/khutbah/khutbah-topic-list.tsx.
...
export const KhutbahTopicList: MissingModuleShape = __moduleSurface;
export type KhutbahTopicList = MissingModuleShape;
