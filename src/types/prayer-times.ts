// #739 Wave 13 — generated typed module boundary for src/types/prayer-times.ts.
...
export const PrayerTimesData: MissingModuleShape = __moduleSurface;
export type PrayerTimesData = MissingModuleShape;
