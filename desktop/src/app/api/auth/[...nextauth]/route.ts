// #739 Wave 13 — generated typed module boundary for desktop/src/app/api/auth/[...nextauth]/route.ts.
...
export const authOptions: MissingModuleShape = __moduleSurface;
export type authOptions = MissingModuleShape;
