// #739 Wave 13 — generated typed module boundary for desktop/src/renderer/lib/logger.tsx.
...
export const logger: MissingModuleShape = __moduleSurface;
export type logger = MissingModuleShape;
