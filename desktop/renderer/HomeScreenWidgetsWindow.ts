// #739 Wave 13 — generated typed module boundary for desktop/renderer/HomeScreenWidgetsWindow.ts.
...
export const WidgetConfig: MissingModuleShape = __moduleSurface;
export type WidgetConfig = MissingModuleShape;
